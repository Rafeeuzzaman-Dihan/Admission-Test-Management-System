...
namespace Project
{
    ...
    {
        string ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\User\Desktop\Project\Project\Database\LocationsDB.mdf;Integrated Security=True;Connect Timeout=30";
        public Locations()
        {
            InitializeComponent();
        }
